...
const coordinationSchema = Object.freeze({
  ...
  properties: {
    ...
    callerAgentName: {
      ...
      minLength: 1,
      maxLength: 128,
      pattern: "^(?:claude|codex|copilot|gemini)-(?:linux|wsl|win|mac|other)-[A-Za-z0-9][A-Za-z0-9._-]{0,95}-[1-9][0-9]*$",
...
function validateCoordination(value) {
  ...
  if (callerAgentName.length > 128 ||
      !/^(?:claude|codex|copilot|gemini)-(?:linux|wsl|win|mac|other)-[A-Za-z0-9][A-Za-z0-9._-]{0,95}-[1-9][0-9]*$/.test(callerAgentName)) {
